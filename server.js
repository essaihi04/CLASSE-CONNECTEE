...
7. Le contenu doit être immédiatement utile : texte d'explication, consigne observable, question précise, synthèse ou critères d'évaluation. Pas de commentaires génériques sur la création du cours. Reprends la progression, les gestes, les mots/exemples et les supports réellement indiqués par la fiche source. N'invente pas des rubriques vagues ou répétitives comme « Je vois », « J'écoute » ou « Je découvre » si elles ne figurent pas dans le document : chaque titre doit nommer l'apprentissage ou le jeu précis.
...
11. Place une question de compréhension après 2 à 4 blocs d'explication et au moins une activité active par séance. Pour une activité association ou tableau, fournis activity avec au moins 2 items dont les réponses proviennent explicitement du PDF. Réserve ces activités textuelles aux tâches où lire et associer des mots est réellement l'objectif. Si l'élève doit écouter, reconnaître une image, manipuler des objets, les classer dans un contenant, les placer sur un schéma ou construire une réponse au tableau, crée plutôt un bloc simulation drag_drop/free_move avec ses objets SVG. En langue au préscolaire et au début du primaire, une discrimination de sons ou un tri mot-image doit être visuel et manipulable, jamais une simple grille de boutons textuels. Ne crée un cadre ou un bloc intitulé « Situation-problème » que si la source en prévoit explicitement un, une seule fois au maximum dans la leçon. Une question formative ou une évaluation n'est jamais une nouvelle situation-problème. N'invente jamais une réponse.

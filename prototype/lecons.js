...
/* ============== COURS : LE SON [M] ET LA LETTRE M ============== */
{
  ...
  quizSets:[
    ...
    {label:"Test 1 · J'entends le son [m] ?",
     ...
     quiz:[
      ...
      {type:'qcm',
        enonce:"Trois images, un seul mot cache le son [m] : singe … camion … ballon.",
        q:"Où se cache le son <b>[m]</b> ?",
        options:["singe","camion","ballon"],
        optionImgs:["son-m-nouveau/images/singe.webp","son-m-nouveau/images/camion.webp","son-m-nouveau/images/ballon.webp"], correct:1,
        fb:"C'est camion : on entend mmmm au milieu. singe et ballon n'ont pas le son mmmm."},
      {type:'vf',
        ...
        correct:false, fb:"Dans table, il n'y a pas de mmmm. Attention à ne pas confondre avec la lettre B."},
      {type:'qcm',
    ...
    {label:"Test 2 · Où se cache le son [m] ?",
     ...
     quiz:[
      {type:'qcm',
        enonce:"Observe les trois cartes : moto, plume, camion.",
      ...
      {type:'qcm',
        enonce:"Dis le mot lentement : ca-mi-on.",
        img:"son-m-nouveau/images/camion.webp", imgCaption:"Un camion",
        q:"Où entends-tu le son <b>[m]</b> dans camion ?",
        options:["Au début","Au milieu","À la fin"], correct:1,
        fb:"Dans camion, on entend mmmm au milieu."},
      {type:'qcm',
      ...
      {type:'association',
        ...
        pairs:[
          ...
          {l:"camion", lImg:"son-m-nouveau/images/camion.webp", r:"au milieu"},
          {l:"plume",  lImg:"son-m-nouveau/images/plume.webp",  r:"à la fin"}
        ],
        fb:"mouton : au début · camion : au milieu · plume : à la fin."},
      {type:'vf',
  ...
  etapes:[
    ...
    {ancrage:"J'écris les trois écritures de la lettre M.",
     phase:"simulation",say:"Pour finir, qui vient écrire au tableau ? Regarde les trois lettres. Prends bien ton temps. Commence en haut. Descends. Remonte. Redescends. Trace la lettre emme majuscule, puis la lettre emme minuscule, puis la lettre emme attachée.",board:{title:"",media:{type:'simulation',src:'son-m-nouveau/sim-05-ecritures-nouveau.html',desc:"Tracer les trois écritures de la lettre M"},lines:[]}},
    {ancrage:"Le son peut durer : mmmm.",
     say:"Bravo les détectives ! Tu connais le son de la lettre M. Tu sais où il se cache dans les mots. Tu reconnais les trois écritures : la lettre emme majuscule, la lettre emme minuscule et la lettre emme attachée. Souviens-toi : le son peut durer : mmmm.",board:{title:"Trace finale",media:{type:'image',src:'son-m-nouveau/images/scene-enfant-gateau.webp',desc:"Le son [m] avec le gâteau"},lines:[{t:"<span class='b'>M fait [m]</span> : <span class='g'>mmmm</span>.",cls:"def"},{t:"Je ferme les lèvres et je prolonge le son.",cls:""},{t:"Je reconnais <span class='b'>M</span>, <span class='g'>m</span> et <span class='o'>𝓂</span>.",cls:""}]}}
  ]
},
